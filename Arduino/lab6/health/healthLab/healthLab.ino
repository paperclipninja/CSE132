...
//****STEPS
  ...
  for(int a=0; a<20; a++)      { 
    ...
    stepArray[2]=point;
    if((stepArray[1])>(stepArray[0]+.5) && (stepArray[1])>(stepArray[2]+.5)) {
     steps++; 
     delay(100);
    }
   }
...
Serial.write("@");
t=millis();
Serial.write((byte)t>>24);
Serial.write((byte)t>>16);
Serial.write((byte)t>>8);
Serial.write((byte)t);
Serial.write(tempKey);
...
//Serial.print("@");
//t=millis();
//Serial.print((byte)t>>24);
//Serial.print((byte)t>>16);
//Serial.print((byte)t>>8);
//Serial.print((byte)t);
//Serial.print(tempKey);
//Serial.print((byte)temperature>>8);
